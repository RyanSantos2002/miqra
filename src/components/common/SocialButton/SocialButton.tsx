  ...
  return (
    ...
    >
      <span className={styles.iconWrapper}>
        {provider === 'google' && (
          <svg viewBox="0 0 24 24" width="18" height="18" className={styles.providerIcon}>
            <path
              fill="#EA4335"
        ...
        {provider === 'github' && (
          <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className={styles.providerIcon}>
